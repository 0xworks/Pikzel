...
// In this backend, ImTextureID is used to store a 'VkDescriptorSet' texture identifier. Read the FAQ about ImTextureID in imgui.cpp.
// WARNING: This will only work properly in 64-bit builds.  Read the commentary in https://github.com/ocornut/imgui/pull/914
...
static void ImGui_ImplVulkan_CreateWindow(ImGuiViewport* viewport)
{
    ...
    const VkFormat requestSurfaceImageFormat[] = {VK_FORMAT_B8G8R8A8_SRGB, VK_FORMAT_R8G8B8A8_SRGB, VK_FORMAT_B8G8R8_SRGB, VK_FORMAT_R8G8B8_SRGB, VK_FORMAT_B8G8R8A8_UNORM, VK_FORMAT_R8G8B8A8_UNORM, VK_FORMAT_B8G8R8_UNORM, VK_FORMAT_R8G8B8_UNORM };
...
void ImGui_ImplVulkan_DestroyTexture(ImTextureID texId) {
   ImGui_ImplVulkan_InitInfo* v = &g_VulkanInitInfo;
   VkDescriptorSet descriptorSet = reinterpret_cast<VkDescriptorSet>(texId);
